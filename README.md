...
- Весь код и материалы проекта находятся **только** в папке `project/`.
- В файле `project/README.md` описана:
  - цель проекта;
  - краткая идея;
  - как запустить проект (команды, зависимости, параметры);
  - как воспроизвести демонстрацию для защиты.
- Отдельный отчёт по проекту в файле `project/report.md`:
